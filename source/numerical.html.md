...
\\[
Z=\sum\_{\mathrm{Young図:} Y}e^{-\beta |Y|}
\\]

と表される。これは実際足し上げを計算することができて

\\[
Z=\frac{1}{\prod\_{n=1}^{\infty} (1-e^{-\beta})}
\\]
...
d\lambda\_{i}
\prod\_{i\lt j}
\sinh^2 \frac 12(\lambda\_i-
\lambda_j)
\exp(-\frac{1}{\beta} \sum\_{i=1}^{N} \lambda\_i^2)
\\]
